        ...
        <div style="height: 60vh;overflow-y: auto;">
            <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="100px" style="width: 400px; margin-left:50px;">
                ...
                <el-form-item label="商品原价" prop="goodsPrice">
                    <el-input v-model.number="parseFloat(temp.goodsPrice).toFixed(2)" />
                </el-form-item>
                <el-form-item label="会员价" prop="goodsVipPrice">
                    <el-input v-model.number="parseFloat(temp.goodsVipPrice).toFixed(2)" />
                </el-form-item>
                <el-form-item label="商品售价" prop="goodsSellPrice">
                    <el-input v-model.number="parseFloat(temp.goodsSellPrice).toFixed(2)" />
                </el-form-item>
                <el-form-item label="广告图片" prop="adEndTime">
                    <el-upload class="avatar-uploader" action="https://jsonplaceholder.typicode.com/posts/"
                        :auto-upload="false" :show-file-list="false" :on-change="upPreview">
