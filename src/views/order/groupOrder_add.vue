<template>
  <el-dialog title="拼团订单详情" width="80%" top="10vh" :before-close="handleCloseDialog" :visible.sync="isDialog">
    <div style="height: 60vh;overflow-y: auto;">
      <el-form ref="dataForm" :model="temp" label-position="right" label-width="120px" style=" margin-left:50px;">
        ...
        <el-form-item label="支付金额">
          <el-input class="form-inp-w" :value="temp.payPrice" />
        </el-form-item>
        ...
        <el-form-item label="拼团状态">
          <el-input class="form-inp-w" v-if="temp.groupStatus == 0" value="失败" />
          <el-input class="form-inp-w" v-else-if="temp.groupStatus == 1" value="组团中" />
          <el-input class="form-inp-w" v-else value="成功" />
        </el-form-item>
        <el-form-item label="退款金额">
          <el-input class="form-inp-w" :value="temp.retMoney" />
        </el-form-item>
        ...
        <el-form-item label="订单状态">
          <el-input class="form-inp-w" v-if="temp.orderState == 1" value="待付款" />
          <el-input class="form-inp-w" v-else-if="temp.orderState == 2" value="待分享" />
          <el-input class="form-inp-w" v-else-if="temp.orderState == 3" value="待发货" />
          <el-input class="form-inp-w" v-else-if="temp.orderState == 4" value="待收货" />
          <el-input class="form-inp-w" v-else value="待评价" />
        </el-form-item>
